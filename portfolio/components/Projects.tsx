...
function Projects({ projects}: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#2272FF]">
      ...
      <div className="w-full absolute top-[30%] bg-[#2272FF]/10 left-0 h-[500px] -skew-y-12" />
    </motion.div>
  );
}
